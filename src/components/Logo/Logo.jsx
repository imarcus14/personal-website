...
import solid from "../../assets/icons/new-i.svg";
...
const Logo = () => {
  ...
  useEffect(() => {
    ...
    gsap.to(bgRef.current, { duration: 1, opacity: 1 });

    // Select all <path> elements
    const paths = document.querySelectorAll(".svg-container path");

    if (paths.length > 0) {
      // Step 1: Animate stroke drawing
      gsap.fromTo(
        paths,
        { drawSVG: "0%", fill: "transparent" }, // Start with no stroke and transparent fill
        {
          drawSVG: "100%",
          duration: 1,
          ease: "power1.inOut",
          ...
          stagger: 0.2,
          onComplete: () => {
            // Step 2: Once stroke is complete, fade in the fill color
            gsap.to(paths, { fill: "white", duration: 1 });
          },
        }
      );
    } else {
      console.error("No paths found for animation.");
    }
  }, []);
  ...
  return (
    <div className="logo-container" ref={bgRef}>
      ...
      <svg
        ...
        width="300.000000pt"
        height="774.000000pt"
        viewBox="0 0 300.000000 774.000000"
